...
class TestOperations(unittest.TestCase):
    ...
    def test_get_many_to_many(self) -> None:
        """Test getting many-to-many triples."""
        many_to_many = {m6, m7, m8, m9}
        self.assertEqual(many_to_many, get_prefix_stratified_many_to_many(triples))
        self.assertEqual(
            [m for m in triples if m not in many_to_many],
            list(exclude_prefix_stratified_many_to_many(triples)),
        )
